          ...
          <Col l="12" xxs="24">
            <div className={styles.dataItem}>
              ...
              <div className={styles.dataItemUnit}>
                ...
                <div className={styles.unitAmount}>982.00</div>
                <div className={styles.unitFooter}>昨日：680.00</div>
              </div>
              <div className={styles.dataItemUnit}>
          ...
          <Col l="12" xxs="24">
            <div className={styles.dataItem}>
              ...
              <div className={styles.dataItemUnit}>
                ...
                <div className={styles.unitAmount}>381.00</div>
                <div className={styles.unitFooter}>昨日：123.00</div>
              </div>
              <div className={styles.dataItemUnit}>
