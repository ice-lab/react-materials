...
export default class ReviewRequestTable extends Component {
  ...
  renderInviteInfo = (value, index, record) => {
    return (
      <div className={styles.inviteInfo}>
        ...
        <span className={styles.inviteName}>{record.invite.name}</span>
      </div>
    );
  };
  ...
  renderSentInfo = (value, index, record) => {
    return (
      <div className={styles.sentInfo}>
        ...
        <span className={styles.sentName}>{record.sent.name}</span>
      </div>
    );
  };
  ...
  renderStatus = (value) => {
    return (
      <span style={{ background: statusColors[value] }} className={styles.statusBtn}>
        {value}
      </span>
    );
  };
