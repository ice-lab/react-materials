...
export default function IntroTab() {
  ...
  const isSelected = (index, target) => (index === target ? 'selected' : ' ');
  ...
  return (
    <div className="scenario">
      ...
      <div className="scenario-slider ">
        <div className="scenario-list">
          <div
            data-index="0"
            onClick={clickTab}
            className={`scenario-item ${isSelected(index, 0)}`}
          >
          ...
          <div
            data-index="1"
            onClick={clickTab}
            className={`scenario-item ${isSelected(index, 1)}`}
          >
          ...
          <div
            data-index="2"
            onClick={clickTab}
            className={`scenario-item ${isSelected(index, 2)}`}
          >
      ...
      <div className="scenario-detail-list bt1px">
        <div className={`scenario-detail-item ${isSelected(index, 0)}`}>
        ...
        <div className={`scenario-detail-item ${isSelected(index, 1)}`}>
          <div className="scenario-detail-left">
            <h4>
              小区生活号
            </h4>
        ...
        <div className={`scenario-detail-item ${isSelected(index, 2)}`}>
          <div className="scenario-detail-left">
            <h4>
              社区理财
            </h4>
      ...
      <div className={`scenario-actions ${isSelected(index, 0)}`}>
      ...
      <div className={`scenario-actions ${isSelected(index, 1)}`}>
        <a className="scenario-action primary" href="#">
          立即接入
        </a>
      ...
      <div className={`scenario-actions ${isSelected(index, 2)}`}>
        <a className="scenario-action primary" href="#">
          立即接入
        </a>
